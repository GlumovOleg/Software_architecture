...
private const string connectionString = "Data Source = clinic.db; Version = 3; Pooling = true; Max Pool Size = 100;";
        public int Create(Consultation item)
        {
            ...
            command.CommandText = 
                @"INSERT INTO Consultations (ClientId, PetId, ConsultationDate, Description)
        ...
        public int Delete(int id)
        {
            ...
            connection.Open();
            SQLiteCommand command = new SQLiteCommand(connection);
            command.CommandText = "DELETE FROME Consultations WHERE ConsultationId = @ConsultationId";
