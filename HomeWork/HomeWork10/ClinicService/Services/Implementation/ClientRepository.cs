...
namespace ClinicService.Services.Implementation
{
    public class ClientRepository : IClientRepository
    {
        ...
        public int Create(Client item)
        {
            ...
            command.CommandText = "INSERT INTO Clients(Document, SurName, FirstName, Patronymic, Birthday) VALUES(@Document, @SurName, @FirstName, @Patrymic, @Birthday)";
        ...
        public int Update(Client item)
        {
            ...
            connection.Open();
            SQLiteCommand command = new SQLiteCommand(connection);
            command.CommandText = "UPDATE Clients SET Document = @Document, SurName = @SurName, FirstName = @FirstName, Patronymic = @Patrymic, Birthday = @Birthday WHERE ClientId = @ClientId";
        ...
        public int Delete(int id)
        {
            ...
            connection.Open();
            SQLiteCommand command = new SQLiteCommand(connection);
            command.CommandText = "DELETE FROME Clients WHERE ClientId = @ClientId";
        ...
        public IList<Client> GetAll()
        {
            ...
            //command.CommandText = "SELECT Document, FistName, SurName FROM Clients";
