...
public class App {
     ...
     * 
     * 2. Создать конкретный автомобиль путём наследовния класса "Car". 
     * 
     ...
     * определить метод "движение" - "полёт".
     * Провести проверку принципа LSP.
     * 
     ...
     * Провести проверку принципа ISP. Создать дополнительный(е) интерфейс(ы) и имплементировать их в 
     * конкретный класс "Car". Провести проверку принципа ISP. 
     * 
     * 11. Создать путём наследования класса "Car" два автомобиля:
     * с бензиновым и дизельным двигателями, имплементировать метод "ЗАправка топливом" интерфейсв
